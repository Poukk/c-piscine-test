...
void cpt_test_exercise() {
    print_exercise("00", "ft_iterative_factorial");
    ...
    for (int i = 0; i < num_tests; i++) {
        ...
        snprintf(actual, sizeof(actual), "%d", ft_iterative_factorial(n));
        
        char test_name[50];
        snprintf(test_name, sizeof(test_name), "Test %d: ft_iterative_factorial(%d)", i + 1, n);
